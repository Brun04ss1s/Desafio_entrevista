        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <h3 class="fw-light">Bruno Gabriel</h3>
        ...
        <div class="row py-lg-5">
            <div class="col-lg-7 mx-auto">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" placeholder="Fulano da Silva Santos">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Telefone:</label>
                    <input type="number" class="form-control" id="telefone" placeholder="(71) 3241-3010">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Observação:</label>
                    <textarea class="form-control" id="observacao" placeholder="Alguma Observação Aqui !" rows="3"></textarea>
                </div>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <?php
                        ...
                        if ($resp = mysqli_query($mysqli, $sql)) {
                            ...
                            $dados[$i] = $reg['nome'];
                            $dados[$i++] = $reg['telefone'];
                            $dados[$i++] = $reg['observacao'];
                            }
                        }
                    ?>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><?php $dados[0]?></p>
                                    <label class="text-uppercase"><strong>Telefone:</strong></label>
                                    <p class="card-text"><?php $dados[1]?></p>
                    ...
                    <?php 
                        //Incluindo os primeiros dados
                        try{
                            if(isset($_POST['submit'])){
                                include_once('clientes_telefone.php');
                                $Cliente = new Cliente_telefone;
                                $nome = $_POST['nome'];
                                $observacao = $_POST['observacao'];
                                $telefone = $_POST['telefone'];
                                
                                $Cliente -> setDados($nome, $observacao, $telefone);
                            }
